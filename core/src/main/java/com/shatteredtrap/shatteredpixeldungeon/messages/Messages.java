...
package com.shatteredtrap.shatteredpixeldungeon.messages;
...
public class Messages {
	...
	private static String[] prop_files = new String[]{
			"com.shatteredtrap.shatteredpixeldungeon.messages.actors.actors",
			"com.shatteredtrap.shatteredpixeldungeon.messages.items.items",
			"com.shatteredtrap.shatteredpixeldungeon.messages.journal.journal",
			"com.shatteredtrap.shatteredpixeldungeon.messages.levels.levels",
			"com.shatteredtrap.shatteredpixeldungeon.messages.plants.plants",
			"com.shatteredtrap.shatteredpixeldungeon.messages.scenes.scenes",
			"com.shatteredtrap.shatteredpixeldungeon.messages.ui.ui",
			"com.shatteredtrap.shatteredpixeldungeon.messages.windows.windows",
			"com.shatteredtrap.shatteredpixeldungeon.messages.misc.misc"
	};
	...
	public static String get(Class c, String k, Object...args){
		String key;
		if (c != null){
			key = c.getName().replace("com.shatteredtrap.shatteredpixeldungeon.", "");
			key += "." + k;
		} else
			key = k;
