...
public class ItemSpriteSheet {
	...
	public static final int WAND_STURDYBOLT    = WANDS+13;
	static {
	...
	public static final int CRYSTAL      = ARTIFACTS+23;
	public static final int RATDUST      = ARTIFACTS+24;
	public static final int RATBEACON1      = ARTIFACTS+25;
	public static final int RATBEACON3      = ARTIFACTS+26;
	public static final int RATBEACON2      = ARTIFACTS+27;
	static{
		...
		assignItemRect(RATDUST,      16, 16);
		assignItemRect(RATBEACON1,      16, 16);
		assignItemRect(RATBEACON3,      16, 16);
		assignItemRect(RATBEACON2,      16, 16);
	}
	...
	public static final int ELIXIR_TRAPSKILL   = ELIXIRS+7;
	static{
	...
	public static final int RACK     = BAGS+5;
	public static final int LOOTBAG     = BAGS+6;
	static{
		...
		assignItemRect(RACK,     15, 16);
		assignItemRect(LOOTBAG,     15, 16);
	}
