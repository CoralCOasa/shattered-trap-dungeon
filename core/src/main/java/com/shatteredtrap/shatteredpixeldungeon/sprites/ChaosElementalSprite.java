...
public class ChaosElementalSprite extends MobSprite {

	public ChaosElementalSprite() {
		super();
		...
		idle = new Animation( 2 / SPDSettings.speeder2(), true );
		idle.frames( frames, 0 );
		
		run = new Animation( 10 / SPDSettings.speeder2(), true );
		run.frames( frames, 0, 1, 2, 3 );
		
		attack = new Animation( 7 / SPDSettings.speeder2(), false );
		attack.frames( frames, 4, 5, 4 );
		
		die = new Animation( 9 / SPDSettings.speeder2(), false );
