...
import com.shatteredtrap.shatteredpixeldungeon.effects.DarkBlock;
...
import com.shatteredtrap.shatteredpixeldungeon.effects.IceBlock;
import com.shatteredtrap.shatteredpixeldungeon.effects.RedBlock;
import com.shatteredtrap.shatteredpixeldungeon.effects.ShieldHalo;
...
import com.shatteredtrap.shatteredpixeldungeon.effects.TorchHalo;
...
public class CharSprite extends MovieClip implements Tweener.Listener, MovieClip.Listener {
	...
	//private static final float MOVE_INTERVAL	= 0.075f;
	...
	public enum State {
		BURNING, LEVITATING, INVISIBLE, PARALYSED, FROZEN, ILLUMINATED, CHILLED, DARKENED, MARKED, HEALING, SHIELDED, REDDENED
	}
	...
	public void move( int from, int to ) {
		...
		motion = new PosTweener( this, worldToCamera( to ), MOVE_INTERVAL * SPDSettings.speeder() );
