...
import com.shatteredtrap.shatteredpixeldungeon.Chrome;
...
import com.shatteredtrap.shatteredpixeldungeon.effects.Fireball;
...
import com.shatteredtrap.shatteredpixeldungeon.ui.LanguageButton;
import com.shatteredtrap.shatteredpixeldungeon.ui.PrefsButton;
import com.shatteredtrap.shatteredpixeldungeon.ui.StyledButton;
import com.shatteredtrap.shatteredpixeldungeon.windows.WndOptions;
import com.shatteredtrap.shatteredpixeldungeon.windows.WndStartGame;
	...
	public void create() {
		...
		*/
		...
		if (SPDSettings.landscape()) {
			...
			btnRankings.setRect(btnPlay.left()-50 + (btnPlay.width()*.33f)+1, btnPlay.bottom()+ GAP, (btnPlay.width()*.67f)-1, BTN_HEIGHT);
			btnBadges.setRect(btnRankings.right()+2, btnRankings.top(), btnRankings.width(), BTN_HEIGHT);
			btnChanges.setRect(btnPlay.left()-11, btnRankings.bottom()+ GAP, btnRankings.width(), BTN_HEIGHT);
			align(btnChanges);
			btnAbout.setRect(btnChanges.right()+2, btnChanges.top(), btnRankings.width(), BTN_HEIGHT);
		} else {
			btnPlay.setRect(title.x, topRegion+GAP, title.width(), BTN_HEIGHT);
			align(btnPlay);
			btnRankings.setRect(title.x, btnPlay.bottom()+ GAP, title.width(), BTN_HEIGHT);
			align(btnRankings);
			btnBadges.setRect(title.x, btnRankings.bottom()+ GAP, title.width(), BTN_HEIGHT);
			align(btnBadges);
			//btnRankings.setRect(btnPlay.left(), btnPlay.bottom()+ GAP, (btnPlay.width()/2)-1, BTN_HEIGHT);
			//btnBadges.setRect(btnRankings.right()+2, btnRankings.top(), btnRankings.width(), BTN_HEIGHT);
			btnChanges.setRect(title.x, btnBadges.bottom()+ GAP, title.width()/2, BTN_HEIGHT);
			align(btnChanges);
			btnAbout.setRect(btnChanges.right()+2, btnChanges.top(), btnRankings.width()/2, BTN_HEIGHT);
