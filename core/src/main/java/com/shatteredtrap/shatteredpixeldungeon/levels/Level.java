...
import com.shatteredtrap.shatteredpixeldungeon.actors.blobs.WellWater;
...
import com.shatteredtrap.shatteredpixeldungeon.actors.buffs.MagicalSight;
import com.shatteredtrap.shatteredpixeldungeon.actors.buffs.MindVision;
import com.shatteredtrap.shatteredpixeldungeon.actors.buffs.Shadows;
import com.shatteredtrap.shatteredpixeldungeon.actors.hero.Hero;
import com.shatteredtrap.shatteredpixeldungeon.actors.hero.HeroClass;
import com.shatteredtrap.shatteredpixeldungeon.actors.hero.HeroSubClass;
import com.shatteredtrap.shatteredpixeldungeon.actors.mobs.Bestiary;
import com.shatteredtrap.shatteredpixeldungeon.actors.mobs.Mob;
import com.shatteredtrap.shatteredpixeldungeon.effects.particles.FlowParticle;
import com.shatteredtrap.shatteredpixeldungeon.effects.particles.WindParticle;
...
import com.shatteredtrap.shatteredpixeldungeon.levels.features.HighGrass;
...
public abstract class Level implements Bundlable {
	...
	public void create() {
		...
		if (!(Dungeon.bossLevel() || Dungeon.depth == 21) /*final shop floor*/) {
			...
			//addItemToSpawn( new ReclaimTrap());
	...
	public void setSize(int w, int h){
		...
		map = new int[length];
		int i = Terrain.WALL;
		if(feeling == Level.Feeling.CHASM){
			i = Terrain.CHASM;
		}else if(feeling == Level.Feeling.STATUE){
			i = Terrain.STATUE;
		}
	...
	public void buildFlagMaps() {
		...
		for (int i=0; i < length(); i++) {
			...
			//mob_passable[i] = (flags & Terrain.SECRET_TRAP) != 0;
