...
import com.shatteredtrap.shatteredpixeldungeon.ui.BadgesList;
import com.shatteredtrap.shatteredpixeldungeon.ui.Icons;
import com.shatteredtrap.shatteredpixeldungeon.ui.ItemSlot;
...
public class WndRanking extends WndTabbed {
	...
	private class StatsTab extends Group {
		...
		public StatsTab() {
			...
			pos = statSlot( this, Messages.get(this, "trapskill"), Integer.toString( Dungeon.hero.getTrapSkill() ), pos );
