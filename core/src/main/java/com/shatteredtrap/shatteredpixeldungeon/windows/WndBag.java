...
import com.shatteredtrap.shatteredpixeldungeon.plants.Plant.Seed;
...
public class WndBag extends WndTabbed {
	...
	public WndBag( Bag bag, Listener listener, Mode mode, String title ) {
		...
		Bag[] bags = {
			stuff.backpack,
			stuff.getItem( VelvetPouch.class ), stuff.getItem( WeaponRack.class ),
	...
	private Image icon( Bag bag ) {
		if (bag instanceof VelvetPouch) {
			...
			return Icons.get( Icons.WEAPONRACK );
		} else {
