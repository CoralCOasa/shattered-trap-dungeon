...
import com.shatteredtrap.shatteredpixeldungeon.ui.CheckBox;
import com.shatteredtrap.shatteredpixeldungeon.ui.OptionSlider;
...
public class WndSettings extends WndTabbed {
	...
	private class DisplayTab extends Group {
		...
		public DisplayTab() {
			...
			brightness.setRect(0, btnOrientation.bottom() + GAP_TINY, WIDTH, SLIDER_HEIGHT);
			add(brightness);
			...
			CheckBox speed = new CheckBox(Messages.get(this, "speed")){
				@Override
				protected void onClick() {
					super.onClick();
					SPDSettings.setSpeed(!checked());
				}
			};
			speed.setRect(0, tileGrid.bottom() + GAP_TINY, WIDTH, BTN_HEIGHT);
			speed.checked(!SPDSettings.speed());
			add(speed);
