...
import com.shatteredtrap.shatteredpixeldungeon.levels.CavesBossLevel;
import com.shatteredtrap.shatteredpixeldungeon.levels.CavesLevel;
import com.shatteredtrap.shatteredpixeldungeon.levels.CityBossLevel;
import com.shatteredtrap.shatteredpixeldungeon.levels.CityLevel;
import com.shatteredtrap.shatteredpixeldungeon.levels.DeadEndLevel;
import com.shatteredtrap.shatteredpixeldungeon.levels.HallsBossLevel;
import com.shatteredtrap.shatteredpixeldungeon.levels.HallsLevel;
import com.shatteredtrap.shatteredpixeldungeon.levels.LastLevel;
import com.shatteredtrap.shatteredpixeldungeon.levels.LastShopLevel;
...
import com.shatteredtrap.shatteredpixeldungeon.levels.PrisonLevel;
...
import com.shatteredtrap.shatteredpixeldungeon.utils.DungeonSeed;
...
public class Dungeon {
	...
	public static boolean elite1spawned = false;
	public static boolean elite2spawned = false;
	...
	private static final String ELITE1SPAWNED = "elite1spawned";
	private static final String ELITE2SPAWNED = "elite2spawned";
	...
	public static void saveGame( int save ) throws IOException {
		try {
			...
			bundle.put( ELITE1SPAWNED, elite1spawned );
			bundle.put( ELITE2SPAWNED, elite2spawned );
	...
	public static void loadGame( int save, boolean fullLoad ) throws IOException {
		...
		elite1spawned = bundle.getBoolean("ELITE1SPAWNED");
		elite2spawned = bundle.getBoolean("ELITE2SPAWNED");
	...
	public static Level loadLevel( int save ) throws IOException {
		...
		//	((RegularLevel) level).removeMagicc();
		//}
		if (level == null){
	...
	public static void setElite1spawned(boolean b){
		elite1spawned = b;
	}

	public static void setElite2spawned(boolean b){
		elite2spawned = b;
	}

	public static void setElite3spawned(boolean b){
		elite3spawned = b;
	}

	public static void setElite4spawned(boolean b){
		elite4spawned = b;
	}
