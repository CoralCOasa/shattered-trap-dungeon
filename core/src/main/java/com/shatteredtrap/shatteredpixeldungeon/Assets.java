...
public class Assets {
	...
	public static final String FILTHJET	= "filthjet.png";
	public static final String DARTSPITTER	= "dartspitter.png";
	public static final String ASSASIN	= "assasin.png";
	public static final String CHAOS	= "chaos.png";
	public static final String DEMONRAT	= "demonrat.png";
	public static final String DANCINGSKELETON	= "dancingskeleton.png";
	public static final String PRISMANCER	= "prismancer.png";
	public static final String TOUGHGHOST	= "toughghost.png";
	public static final String METEOR	= "meteor.png";
	public static final String BOMBSPIDER	= "bombspider.png";
	public static final String RATCLOWN	= "ratclown.png";
	public static final String ORC = "orc.png";
	public static final String KEYCHAIN = "keychain.png";
	public static final String ELECTRO = "electro.png";
	public static final String HOLE = "hole.png";
	public static final String AMOGUS = "amogus.png";
	public static final String FLOWER = "fireflower.png";
	public static final String SLAVER = "slaver.png";
	public static final String SKELECRABAT = "skelecrabat.png";
	public static final String SPOOK = "frostspook.png";
	public static final String SPECTRAL = "spectralrat.png";
	public static final String GOD = "ratgod.png";
	public static final String BIGRAT = "bigrat.png";
	...
	public static final String BOMBSHEEP	= "bombsheep.png";
