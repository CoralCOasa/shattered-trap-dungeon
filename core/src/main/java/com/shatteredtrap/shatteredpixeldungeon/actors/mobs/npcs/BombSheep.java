...
import com.shatteredtrap.shatteredpixeldungeon.sprites.SheepSprite;
import com.watabou.utils.Random;

public class BombSheep extends NPC {

	private static final String[] LINE_KEYS = {"baa1", "baa2", "baa3", "baa4"};

	{
		spriteClass = BombSheepSprite.class;
	}
