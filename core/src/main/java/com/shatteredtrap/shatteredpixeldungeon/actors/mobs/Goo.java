...
import com.shatteredtrap.shatteredpixeldungeon.actors.blobs.GooWarn;
...
import com.shatteredtrap.shatteredpixeldungeon.sprites.GooSprite;
...
public class Goo extends Mob {
	...
	public int defenseProc( Char enemy, int damage ) {
		...
		for (Mob mob : Dungeon.level.mobs) {
			if (mob instanceof Gnoll || mob instanceof FilthJet || mob instanceof Crab || mob instanceof Swarm) {
				mob.aggro( enemy );
			}
		}
