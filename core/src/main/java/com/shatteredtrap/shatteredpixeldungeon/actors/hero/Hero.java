...
import com.shatteredtrap.shatteredpixeldungeon.GamesInProgress;
...
import com.shatteredtrap.shatteredpixeldungeon.actors.buffs.Barkskin;
import com.shatteredtrap.shatteredpixeldungeon.actors.buffs.Berserk;
...
import com.shatteredtrap.shatteredpixeldungeon.actors.buffs.Combo;
...
import com.shatteredtrap.shatteredpixeldungeon.actors.buffs.Foresight;
import com.shatteredtrap.shatteredpixeldungeon.actors.buffs.Fury;
...
import com.shatteredtrap.shatteredpixeldungeon.actors.buffs.MindVision;
import com.shatteredtrap.shatteredpixeldungeon.actors.buffs.Momentum;
import com.shatteredtrap.shatteredpixeldungeon.actors.buffs.Paralysis;
import com.shatteredtrap.shatteredpixeldungeon.actors.buffs.Regeneration;
import com.shatteredtrap.shatteredpixeldungeon.actors.buffs.SnipersMark;
...
import com.shatteredtrap.shatteredpixeldungeon.effects.CheckedCell;
import com.shatteredtrap.shatteredpixeldungeon.effects.Flare;
import com.shatteredtrap.shatteredpixeldungeon.effects.Speck;
import com.shatteredtrap.shatteredpixeldungeon.items.Amulet;
import com.shatteredtrap.shatteredpixeldungeon.items.Ankh;
import com.shatteredtrap.shatteredpixeldungeon.items.Dewdrop;
import com.shatteredtrap.shatteredpixeldungeon.items.Heap;
import com.shatteredtrap.shatteredpixeldungeon.items.Heap.Type;
...
import com.shatteredtrap.shatteredpixeldungeon.items.armor.glyphs.AntiMagic;
import com.shatteredtrap.shatteredpixeldungeon.items.armor.glyphs.Brimstone;
import com.shatteredtrap.shatteredpixeldungeon.items.armor.glyphs.Viscosity;
...
import com.shatteredtrap.shatteredpixeldungeon.items.keys.CrystalKey;
...
import com.shatteredtrap.shatteredpixeldungeon.scenes.SurfaceScene;
...
import com.shatteredtrap.shatteredpixeldungeon.ui.AttackIndicator;
...
import com.shatteredtrap.shatteredpixeldungeon.windows.WndMessage;
import com.shatteredtrap.shatteredpixeldungeon.windows.WndResurrect;
import com.shatteredtrap.shatteredpixeldungeon.windows.WndTradeItem;
...
public class Hero extends Char {
	...
	private int trapSkill = 0;
	private int currentTrapSkill = 0;
	private int currentTrapSkill2 = 0;
	...
	public int getCurrentTrapSkill(){
		return currentTrapSkill;
	}

	public int getCurrentTrapSkill2(){
		return currentTrapSkill2;
	}

	public void increaseTrapSkill(){
		trapSkill+=1;
	}

	public void decreaseTrapSkill(){
		trapSkill-=1;
	}

	public void setCurrentTrapSkill(int keke){
		currentTrapSkill = keke;
	}

	public void setCurrentTrapSkill2(int keke){
		currentTrapSkill2 = keke;
	}
	...
	private static final String TRAPSKILL     = "trapskill";
	private static final String CURRENT_TRAPSKILL     = "current_trapskill";
	private static final String CURRENT_TRAPSKILL2     = "current_trapskill2";
	...
	public void storeInBundle( Bundle bundle ) {
		...
		bundle.put( TRAPSKILL, trapSkill);
		bundle.put( CURRENT_TRAPSKILL, currentTrapSkill );
		bundle.put( CURRENT_TRAPSKILL2, currentTrapSkill2 );
	...
	public void restoreFromBundle( Bundle bundle ) {
		...
		trapSkill = bundle.getInt( TRAPSKILL );
		currentTrapSkill = bundle.getInt( CURRENT_TRAPSKILL );
		currentTrapSkill2 = bundle.getInt( CURRENT_TRAPSKILL2 );
	...
	public int attackSkill( Char target ) {
		...
		if (belongings.armor!=null&&belongings.armor instanceof ScaleCrystalArmor){
			accuracy *= 1.25;
		}
	...
	public int damageRoll() {
		...
		if(belongings.armor!=null&&belongings.armor instanceof MailWarArmor){
			dmg *= 1.15f;
		}
	...
	public float attackDelay() {
		if (belongings.armor!=null&&belongings.armor instanceof PlateTimeArmor && Random.Int(5)==0){
			return 0f;
		}
		if (belongings.weapon != null) {
	...
	private boolean actDescend( HeroAction.Descend action ) {
		...
		if (pos == stairs && pos == Dungeon.level.exit) {
			...
			RatDust dust = Dungeon.hero.belongings.getItem( RatDust.class );
			if(beacon!=null && dust==null){
				GLog.w("A mysterious force prevents you from ascending! Stick with the ritual!");
				ready();
				return false;
			}else{
				curAction = null;
				RatDust dusty = Dungeon.hero.belongings.getItem( RatDust.class );
				if(dusty!=null){
					dusty.detach(Dungeon.hero.belongings.backpack);
				}
	...
	public void damage( int dmg, Object src ) {
		...
		if (src instanceof Char && belongings.armor!=null&&belongings.armor instanceof ScaleSolarArmor){
			int i1 = Random.Int(101);
			int i2 = Random.Int(101);
			if(i1<i2){
				i1=i2;
			}
			dmg*=i1/100;
