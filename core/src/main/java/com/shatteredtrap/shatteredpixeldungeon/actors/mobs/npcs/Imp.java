...
import com.shatteredtrap.shatteredpixeldungeon.actors.mobs.Golem;
...
import com.shatteredtrap.shatteredpixeldungeon.windows.WndImp;
...
public class Imp extends NPC {
	...
	public boolean interact() {
		...
		if (Quest.given) {
			...
			if (tokens != null && (tokens.quantity() >= 6 || (!Quest.alternative && tokens.quantity() >= 5))) {
