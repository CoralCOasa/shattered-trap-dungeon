...
package com.shatteredtrap.shatteredpixeldungeon.actors;
...
import com.shatteredtrap.shatteredpixeldungeon.actors.buffs.Doom;
import com.shatteredtrap.shatteredpixeldungeon.actors.buffs.EarthImbue;
...
import com.shatteredtrap.shatteredpixeldungeon.actors.buffs.FrostImbue;
import com.shatteredtrap.shatteredpixeldungeon.actors.buffs.Haste;
...
import com.shatteredtrap.shatteredpixeldungeon.actors.buffs.ShieldBuff;
import com.shatteredtrap.shatteredpixeldungeon.actors.buffs.Slow;
import com.shatteredtrap.shatteredpixeldungeon.actors.buffs.Speed;
import com.shatteredtrap.shatteredpixeldungeon.actors.buffs.Stamina;
...
import com.shatteredtrap.shatteredpixeldungeon.items.weapon.missiles.darts.ShockingDart;
...
public abstract class Char extends Actor {
	...
	public boolean attack( Char enemy ) {
		...
		if (hit( this, enemy, false )) {
			...
			if (this.buff(MagicalFury.class) != null){
				dmg = dmg * 2;
			}
			if (this.buff(Weak.class) != null){
	...
	public void damage( int dmg, Object src ) {
		...
		if (this.buff(Vulnerable.class) != null){
